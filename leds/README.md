...
- gcc -o led_test led_test.c *.c -I. -lm

Explanation: compile the code along with the library source files (*.c) and include the current directory (-I.) for header files.
